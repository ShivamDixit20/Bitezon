...
const API_BASE = 'http://localhost:3000/api/swiggy';
...
function SwiggyTest() {
  ...
  return (
    <div className="swiggy-test">
      <h1>🍔 Swiggy API Tester</h1>
            ...
            <div className="cards-grid">
              {restaurants.map((r) => (
                <div key={r.id} className="card">
                  ...
                  {r.offers.length > 0 && <p className="offer">🎉 {r.offers[0]}</p>}
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="test-section">
        ...
        {orderResult && (
          <div className="results order-result">
            <h3>✅ Order Placed!</h3>
